...
if (__name__== '__main__' or __name__=='farmer_predict_cost') and __package__ is None:
    import sys
    from os import path
...
aggregator_wise_TCost_correct = Outliers.aggregator_wise_TCost_correct  # {(aggregator_id, mandi_id, date): ()}
...
aggregator_vehicle_market_data_query_result = Tables.aggregator_vehicle_market_data_query_result
...
# ______________________________________________________Extra Code______________________________________________________
